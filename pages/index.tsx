...
const Home: NextPage = () => {
  useEffect(() => {
    ...
    Promise.all([
      ...
      Promise.all([jsResponse.text(), wasmResponse.text()]).then(
        ([jsSvg, wasmSvg]) => {
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          name="description"
          content="Maze generator and solver in JavaScript and Wasm"
        />
        ...
        <meta
          ...
          content="Maze solver in JavaScript at Wasm Vercel Edge Functions"
        />
        <meta
          name="twitter:image"
          content="https://wasm-on-the-edge.vercel.app/screenshot.png"
        />
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.metadata}>
          <div>
            ...
            <a href="https://vercel.com/edge">Vercel Edge Functions</a>
          </div>

          <div className={styles.mazeMetadata}>
            Maze number:{" "}
            <span id="mazeNumber" className={styles.mazeNumber}>
              generating
            </span>
          </div>
        </div>
